...
import { addOwnerV1 }       from '../../channel/addowner/v2'
...
describe('Testing basic functionality', () => {
    test('Single owner leaving', () => {
        ...
        addownerV1(KevinIdToken.token, channelId, BobIdToken.uId);
        const res = request('GET','127.0.0.1:2000/src/channel/removeowner/v1.ts', {
            qs: {
