...
describe('Tests for return type for channelDetailsV1', () => {
    ...
    test('ChannelId does not refer to a valid channel2', () => {
        ...
        expect(() => channelDetailsV1(authUserId.authUserId, null)).toThrow(Error);
    ...
    test('invalid authUserId', () => {
        ...
        expect(() => channelDetailsV1(null, cId)).toThrow(Error);
    });
    ...
    test('ChannelId is valid, but user is not a member of the channel', () => {
        ...
        expect(() => channelDetailsV1(authUserId2.authUserId, channelId.channelId)).toThrow(Error);
        expect(() => channelDetailsV1(authUserId.authUserId, channelId2.channelId)).toThrow(Error);
    });
